...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/noisylist#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/noisylist
```

A live public deployment of this template is available at [https://noisylist.templates.workers.dev](https://noisylist.templates.workers.dev)
